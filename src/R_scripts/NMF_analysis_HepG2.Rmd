...
```{r}
path = "/media/ag-cherrmann/echernova/model_input/HepG2/positives_HepG2_CTCF-from-ChIP.csv"
cell_name = "HepG2"
set.seed(6575)
...
```
Optimal k + k that was optimal for the other cell lines:
